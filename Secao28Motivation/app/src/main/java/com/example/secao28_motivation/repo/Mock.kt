package com.example.secao28_motivation.repo
...
class Mock {
    private val ALL = Constants.PHRASE.ALL
    private val HAPPY = Constants.PHRASE.HAPPY
    private val MORNING = Constants.PHRASE.MORNING
